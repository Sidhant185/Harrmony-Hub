          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#121212] text-white/70">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex justify-center items-center gap-2 py-2.5 px-4 border border-white/20 rounded-lg bg-[#1a1a1a] text-white hover:bg-white/5 transition-all hover:scale-105"
              >
